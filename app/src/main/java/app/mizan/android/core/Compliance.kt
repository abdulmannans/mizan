...
/**
 * Canonical copy. The disclaimer ships verbatim; do not soften it and do not add "recommend",
 * "assured" or "best fund" language anywhere in the app.
 */
object Compliance {

    const val DISCLAIMER =
        "Shariah / halal labels in this app are curated screens for personal use. They are not a " +
            "fatwa, not a certified Shariah-board ruling, and not investment advice. Past " +
            "performance does not guarantee future returns."

    const val DISCLAIMER_SHORT = "Analytical signal, not investment advice."
